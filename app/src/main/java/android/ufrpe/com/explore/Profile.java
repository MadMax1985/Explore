...
public class Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = (ImageView) findViewById(R.id.imageUserView);
        editText = (EditText) findViewById(R.id.editUserName);
        progressBarUse = (ProgressBar) findViewById(R.id.progressBarProfile);
        buttonUserProfile = (Button) findViewById(R.id.saveUserInfo);
        buttonNext = (Button) findViewById(R.id.userList);
...
*/
    ...
    private void uploadImageToFirebaseStorage() {
        ...
        if(uriProfileImage != null){
            progressBarUse.setVisibility(View.VISIBLE);
            profileImageReference.putFile(uriProfileImage).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    progressBarUse.setVisibility(View.GONE);
